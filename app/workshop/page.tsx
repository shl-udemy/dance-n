  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="py-12 px-6 text-center bg-white">
        <h2 className="text-2xl font-bold text-[#5A3E2B] mb-4">
      ...
      {/* Dancers placeholder */}
      <section className="py-12 px-6 bg-[#F8F1E7] text-center" aria-hidden="true">
        <div className="text-7xl mb-4">💃🕺</div>
        <p className="text-xl font-bold text-[#5A3E2B]">אז ככה...</p>
      </section>

      {/* No barriers */}
      <section className="py-12 px-6 bg-white" aria-label="למה כדאי להצטרף">
      ...
      <section className="py-12 px-6 bg-gradient-to-br from-[#C96A2B] to-[#E58E26] text-center text-white">
        <div className="max-w-md mx-auto">
          <h2 className="text-2xl font-extrabold mb-6">ב-3 מפגשים של שעתיים:</h2>
          <div className="space-y-3 text-lg leading-relaxed text-center mb-6">
            <p><span aria-hidden="true">💃</span> נלמד את צעדי הבסיס</p>
            <p><span aria-hidden="true">🎵</span> נכיר 15–20 ריקודי מתחילים</p>
            <p><span aria-hidden="true">😄</span> נתרגל יחד בקצב נעים</p>
          </div>
          <p className="text-xl font-semibold">תצברו ביטחון ותצטרפו למעגל בכיף ובחיוך <span aria-hidden="true">🎶</span></p>
        </div>
      </section>
      ...
      <section className="py-12 px-6 bg-white text-center">
        <div className="max-w-md mx-auto bg-[#F8F1E7] rounded-3xl px-6 py-8 border border-[#5A3E2B]/20">
          <p className="text-lg font-semibold text-[#5A3E2B] leading-relaxed">
            <span aria-hidden="true">👩‍🦰</span> בהדרכת נילי אלגזר
            <br />
            ...
            נתרגל יחד שוב ושוב
            <br />
            עד שתרגישו בטוחים ותיהנו לרקוד <span aria-hidden="true">🫶</span>
          </p>
        </div>
      </section>

      {/* Pricing */}
      <section className="py-12 px-6 bg-[#F8F1E7] text-center" aria-label="פרטי מחיר">
        <div className="max-w-sm mx-auto bg-white rounded-3xl shadow-lg border border-[#5A3E2B]/20 px-6 py-8">
          <div className="text-4xl mb-5" aria-hidden="true">🏷️</div>
          <div className="space-y-2 text-[#5A3E2B] text-base mb-6">
            <p><span aria-hidden="true">📅</span> 3 מפגשים · 6 שעות ממוקדות</p>
            <p><span aria-hidden="true">👥</span> קבוצה קטנה – עד 10 משתתפים בלבד</p>
            <p><span aria-hidden="true">⭐</span> ליווי אישי, תרגול מעשי</p>
          </div>
          <div className="border-t border-[#5A3E2B]/10 pt-5">
            <p className="text-4xl font-extrabold text-[#D9A441]">
              <span className="sr-only">מחיר:</span>480 ₪
            </p>
      ...
      {/* Signup form */}
      <section className="py-14 px-6 bg-gradient-to-b from-[#C96A2B] to-[#E58E26] text-center" aria-label="טופס הרשמה לסדנא">
        <div className="max-w-md mx-auto">
